										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="https://www.wponlinesupport.com/plugins-documentation/documentwp-team-showcase-slider/?utm_source=hp&event=doc" target="_blank"><?php _e('Documentation', 'wp-team-showcase-and-slider'); ?></a>									
													<a class="button button-primary" href="http://demo.wponlinesupport.com/team-showcase-and-slider-demo/?utm_source=hp&event=demo" target="_blank"><?php _e('Demo for Designs', 'wp-team-showcase-and-slider'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/wp-team-showcase-slider/?utm_source=hp&event=go_premium" target="_blank"><?php _e('Go Premium ', 'wp-team-showcase-and-slider'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/wp-team-showcase-and-slider/?utm_source=hp&event=pro_demo" target="_blank"><?php _e('View PRO Demo ', 'wp-team-showcase-and-slider'); ?></a>			</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p>Enjoyed this plugin? You can help by rate this plugin <a href="https://wordpress.org/support/plugin/wp-team-showcase-and-slider/reviews/?filter=5" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
